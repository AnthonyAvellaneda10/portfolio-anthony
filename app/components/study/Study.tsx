...
export default function Study() {
    ...
    <div className="about__container studies container__section grid">
        ...
        <div>
            ...
            <p className="home__info-description cycle-info">
                Egresado
            </p>
        </div>
    ...
    <div className="text-center mt-[20px]">
        <a href="https://drive.google.com/file/d/1PV5VYRhMaLrKH48NgmmqdxMfzHeiueJA/view" target="_blank"
            className="button academico btn-avance">
            <div className="avance-curricular">
                Avance Curricular
                <img src="icons/avance_academico.webp" alt="Logo de Avance Curricular" />
            </div>
        </a>
    </div>
